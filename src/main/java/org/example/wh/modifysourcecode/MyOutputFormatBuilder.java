...
import org.apache.flink.connector.jdbc.internal.executor.*;
...
/**
 * @author wh
 * @create 2023/8/6 13:08
 */
public class MyOutputFormatBuilder implements Serializable {

    private static final long serialVersionUID = 1L;

    private MyConnectorOptions jdbcOptions;
    private JdbcExecutionOptions executionOptions;
    private JdbcDmlOptions dmlOptions;
    private TypeInformation<RowData> rowDataTypeInformation;
    private DataType[] fieldDataTypes;

    public MyOutputFormatBuilder() {}

    public MyOutputFormatBuilder setJdbcOptions(MyConnectorOptions jdbcOptions) {
        this.jdbcOptions = jdbcOptions;
        return this;
    }

    public MyOutputFormatBuilder setJdbcExecutionOptions(JdbcExecutionOptions executionOptions) {
        this.executionOptions = executionOptions;
        return this;
    }

    public MyOutputFormatBuilder setJdbcDmlOptions(JdbcDmlOptions dmlOptions) {
        this.dmlOptions = dmlOptions;
        return this;
    }

    public MyOutputFormatBuilder setRowDataTypeInfo(TypeInformation<RowData> rowDataTypeInfo) {
        this.rowDataTypeInformation = rowDataTypeInfo;
        return this;
    }

    public MyOutputFormatBuilder setFieldDataTypes(DataType[] fieldDataTypes) {
